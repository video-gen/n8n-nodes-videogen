...
/* eslint-disable */
import { NodeApiError, NodeConnectionTypes, type IDataObject, type IExecuteFunctions, type INodeExecutionData, type INodeType, type INodeTypeDescription } from "n8n-workflow";

const BASE_URL = "https://api.videogen.io";
const POLL_INTERVAL_MS = 5000;
const POLL_TIMEOUT_MS = 3600000;
const WORKFLOW_STARTS: Record<string, { method: string; path: string; jsonKeys: string[]; requiredBodyKeys: string[] }> = {
  "promptToVideoClip": {
    "method": "POST",
